import 'package:thara/Presentation/screens/authentication/nafaz_login/nafaz_login_controller.dart';

import '../../../../../index/index_main.dart';

class LoginNafazScreen extends StatelessWidget {
  const LoginNafazScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NafazLoginController>(
      init: NafazLoginController(),
      builder: (controller) {
        return Scaffold(
                  ...
                  Expanded(
                    child: Center(
                      child: () {
                        ...
                        } else if (controller.address_individual_error ==
                            true) {
                          return Column(
