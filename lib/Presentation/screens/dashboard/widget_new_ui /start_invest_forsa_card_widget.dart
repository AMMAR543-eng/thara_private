...
class _RiskBadge extends StatelessWidget {
  ...
  const _RiskBadge({required this.value});

  @override
  Widget build(BuildContext context) {
    Color badgeColor = AppColors.green_light;
    if (value.contains("risk_high".tr)) badgeColor = AppColors.errorForeground;
    if (value.contains("risk_medium".tr))
      badgeColor = AppColors.content_secondary;
