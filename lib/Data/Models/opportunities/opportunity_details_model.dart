import '../../../Domain/entity/opportunities/opportunity_details_entity.dart';
import '../process/trade_account_model.dart';
import 'investment_limitation_model.dart';
...
class OpportunityDetailsModel extends OpportunityDetailsEntity {
  ...
  Map<String, dynamic> toJson() {
    return {
      'data': {
        'opportunity': (opportunitiesItems as OpportunitiesItemsResponse?)
            ?.toJson(),
