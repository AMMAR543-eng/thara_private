...
class AppButtonTheme extends ThemeExtension<AppButtonTheme> {
  ...
  factory AppButtonTheme.fromColorMapping(ColorMapping colorMapping) {
    return AppButtonTheme(
      ...
      primaryButtonHover: colorMapping.primaryButtonHover,
  ...
  ThemeExtension<AppButtonTheme> lerp(
    ...
    return AppButtonTheme(
      primaryButtonDefault: Color.lerp(
        primaryButtonDefault,
        other.primaryButtonDefault,
        t,
      )!,
      ...
      primaryButtonFocused: Color.lerp(
        primaryButtonFocused,
        other.primaryButtonFocused,
        t,
      )!,
      primaryButtonEnabled: Color.lerp(
        primaryButtonEnabled,
        other.primaryButtonEnabled,
        t,
      )!,
      ...
      secondaryButtonDefault: Color.lerp(
        secondaryButtonDefault,
        other.secondaryButtonDefault,
        t,
      )!,
      secondaryButtonHover: Color.lerp(
        secondaryButtonHover,
        other.secondaryButtonHover,
        t,
      )!,
      secondaryButtonFocused: Color.lerp(
        secondaryButtonFocused,
        other.secondaryButtonFocused,
        t,
      )!,
      secondaryButtonEnabled: Color.lerp(
        secondaryButtonEnabled,
        other.secondaryButtonEnabled,
        t,
      )!,
      outlineButtonText: Color.lerp(
        outlineButtonText,
        other.outlineButtonText,
        t,
      )!,
      outlineButtonDefault: Color.lerp(
        outlineButtonDefault,
        other.outlineButtonDefault,
        t,
      )!,
      outlineButtonHover: Color.lerp(
        outlineButtonHover,
        other.outlineButtonHover,
        t,
      )!,
      outlineButtonFocused: Color.lerp(
        outlineButtonFocused,
        other.outlineButtonFocused,
        t,
      )!,
      outlineButtonEnabled: Color.lerp(
        outlineButtonEnabled,
        other.outlineButtonEnabled,
        t,
      )!,
    );
  }
