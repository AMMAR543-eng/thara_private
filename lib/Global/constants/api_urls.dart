...
class ApiConstatns {
  ...
  static String get key_encryption {
    ...
    if (key.isEmpty) {
      throw Exception("❌ KEY_ENCRYPTION is missing!");
    }
  ...
  static String get inv_encryption {
    ...
    if (iv.isEmpty || iv.length != 16) {
      throw Exception("❌ IV_ENCRYPTION is invalid!");
    }
  ...
  static String get withdrawal_requests => _url('withdrawal_requests');
  ...
  static String opportunityById(String id) => _urlWithId('opportunities', id);

  static String get invests => _url('subscriptions');

  static String subscribe(String id) => _url('opportunities/$id/subscribe');
  ...
  static String get initialResetPasswordUrl => _url('reset-password-request');

  static String get citizenShips => _url('citizen_ships');

  static String get registerEmail => _url('register/email');

  static String get registerResendOtp => _url('register/resend/otp');

  static String get registerVerifyOtp => _url('register/verify/email');

  static String get registerBasicInfo => _url('register/account/basic_info');

  static String get nafathGetCode => _url('register/nafath/get/code');

  static String get nafathCheckStatus => _url('register/nafath/check/status');
  ...
  static String get registerKYCQuestions => _url('register/kyc');

  static String get singingAgreementDetails =>
      _url('register/signing/agreement/review');

  static String get singingWithSirar => _url('register/signing/agreement');

  static String get upddatePassword => _url('update-password');

  static String get changePassword => _url('profile/change_password');

  static String get changeEmailRequestOtp =>
      _url('profile/request_change_email_otp');

  static String get changeEmailSubmit => _url('profile/request_change_email');

  static String get verifyEmail => _url('profile/verify_new_email');

  static String get BIOMETRIC => _url('biometrics/store');

  static String get changePhoneRequestOtp =>
      _url('profile/change_phone_number_otp');

  static String get changePhoneSubmit => _url('profile/change_phone_number');

  static String get change_profile_photo =>
      _url('profile/change_profile_photo');

  static String get verifyPhone => _url('profile/verify_new_phone');

  static String get storeTicket => _url('tickets/store');

  static String get deleteMyProfile => _url('profile/delete-account');

  static String get article => _url('articles');

  static String get faq => _url('pages/faqs');

  static String get finicial => _url('pages/financial_statements');

  static String get upgrade_professional =>
      _url('request/upgrade_to_professional_investor');

  static String get autoInvestmentConfig => _url('auto_invest_config');
  ...
  static String opportunityWeb(String id) => _web('opportunities/$id');
